...
var DB_MODEL_1 = require("../../Models/DB_MODEL");
var configurePassport = function () { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        passport_1.default.use(new passport_google_oauth2_1.Strategy({
            ...
            (function () { return __awaiter(void 0, void 0, void 0, function () {
                var user, user_1, error_1;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            _a.trys.push([0, 6, , 7]);
                            return [4 /*yield*/, DB_MODEL_1.userModel.findOne({ email: profile.email })];
                        case 1:
                            user = _a.sent();
                            if (!!user) return [3 /*break*/, 3];
                            return [4 /*yield*/, DB_MODEL_1.userModel.create({
                                    googleId: profile.id,
                        ...
                        case 2:
                            ...
                            return [3 /*break*/, 5];
                        case 3:
                            if (!!user.googleId) return [3 /*break*/, 5];
        ...
        passport_1.default.deserializeUser(function (id, done) { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, DB_MODEL_1.userModel.findById(id)];
                    case 1:
                        user = _a.sent();
